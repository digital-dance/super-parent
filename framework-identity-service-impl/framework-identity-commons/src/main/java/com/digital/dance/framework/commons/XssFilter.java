...
public class XssFilter implements Filter {
	...
	public void doFilter(ServletRequest xssRequest, ServletResponse xssResponse, FilterChain xssChain) throws IOException, ServletException {
		...
		((HttpServletResponse)xssResponse).setHeader("Access-Control-Allow-Headers", "Origin, No-Cache, SESSION, Cookie, Set-Cookie, X-Requested-With, If-Modified-Since, Pragma, Last-Modified, Cache-Control, Expires, Content-Type, X-E4M-With, Access-Control-Allow-Origin, Access-Control-Allow-Methods, X-Auth-Token, Access-Control-Allow-Credientials");
