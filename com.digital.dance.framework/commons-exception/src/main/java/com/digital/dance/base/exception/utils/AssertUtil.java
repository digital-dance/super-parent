package com.digital.dance.base.exception.utils;
...
public class AssertUtil
{
  ...
  public static void isInstanceOf(Class<?> type, Object obj, String message)
  {
    ...
    if (!type.isInstance(obj))
      throw new ApplicationException(new StringBuilder().append(message).append(" Object of class [").append(obj != null ? obj.getClass().getName() : "null").append("] must be an instance of ").append(type).toString());
  }
  ...
  public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
    ...
    if ((subType == null) || (!superType.isAssignableFrom(subType)))
      throw new ApplicationException(new StringBuilder().append(message).append(subType).append(" is not assignable to ").append(superType).toString());
  }
  ...
  public static void assertOneOfThem(short a, String errorMessage, short[] values)
  {
    ...
    if (values != null) {
      ...
      throw new ApplicationException("values为空");
    }
    if (!pass)
      throw new ApplicationException(errorMessage);
  }
  ...
  public static void assertTimeRange(Date start, Date end, String errorMessage)
  {
    if ((start == null) || (end == null)) {
      throw new ApplicationException("start或end为空");
    }
    if (start.after(end))
      throw new ApplicationException(errorMessage);
  }
